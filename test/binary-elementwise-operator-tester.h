 ...
 public:
  ...
  void TestF16() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      const float output_min = fp16_ieee_to_fp32_value(fp16_ieee_from_fp32_value(num_output_elements == 1 ?
        -std::numeric_limits<float>::infinity() : accumulated_min + accumulated_range / 255.0f * float(qmin())));
      const float output_max = fp16_ieee_to_fp32_value(fp16_ieee_from_fp32_value(num_output_elements == 1 ?
      ...
      switch (operation_type()) {
        case OperationType::Add:
          ASSERT_EQ(xnn_status_success,
            xnn_create_add_nd_f16(
              output_min, output_max,
              0, &binary_elementwise_op));
          break;
        // case OperationType::Divide:
        //   ASSERT_EQ(xnn_status_success,
        //     xnn_create_divide_nd_f16(
        //       output_min, output_max,
        //       0, &binary_elementwise_op));
        //   break;
        // case OperationType::Maximum:
        //   ASSERT_EQ(xnn_status_success,
        //     xnn_create_maximum_nd_f16(
        //       0, &binary_elementwise_op));
        //   break;
        // case OperationType::Minimum:
        //   ASSERT_EQ(xnn_status_success,
        //     xnn_create_minimum_nd_f16(
        //       0, &binary_elementwise_op));
        //   break;
        // case OperationType::Multiply:
        //   ASSERT_EQ(xnn_status_success,
        //     xnn_create_multiply_nd_f16(
        //       output_min, output_max,
        //       0, &binary_elementwise_op));
        //   break;
        // case OperationType::Subtract:
        //   ASSERT_EQ(xnn_status_success,
        //     xnn_create_subtract_nd_f16(
        //       output_min, output_max,
        //       0, &binary_elementwise_op));
        //   break;
        // case OperationType::SquaredDifference:
        //   ASSERT_EQ(xnn_status_success,
        //     xnn_create_squared_difference_nd_f16(
        //       0, &binary_elementwise_op));
          break;
        default:
